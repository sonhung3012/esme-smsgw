...
import com.fis.esme.client.DailySummaryTransfererClient;
...
public class DialogKPIDailySummary extends Window implements Action.Handler,
	...
	public DialogKPIDailySummary() {
		super(TM.get(DialogKPIDailySummary.class.getName()));
		LogUtil.logAccess(DialogKPIDailySummary.class.getName());
		this.setWidth("400px");
	...
	private void onAccept() {
		try {
			if (formIsValid()) {
				...
				DailySummaryTransferer smsService = DailySummaryTransfererClient
						.getService();
				...
				String[] column1 = new String[] { "No.", "summaryDate",
						"totalSmsIncome", "totalSmsIncomeIncorrect"  ,
						"totalSmsIncomeFail", "totalSmsIncomeCpReceived" };

				String[] column2 = new String[] { "No.", "summaryDate",
						"totalSmsOutbound", "totalSmsSubmitFail",
						"totalSmsAckFail", "totalSmsMobileReceived",
						"totalSmsMobileNoReveived", "totalSmsWaitingDelivery" };

				ArrayList<String[]> columns = new ArrayList<String[]>();
				columns.add(column1);
				columns.add(column2);
				List<EsmeDailySummary> list = smsService.findAllByDate(
						searcher.getFromDate(), searcher.getToDate());
				...
				int stt = 1, stt1 = 1;
				for (EsmeDailySummary smsLog : list) {

					obj1 = new Vector<Object>();
					obj1.add(stt);
					obj1.add((smsLog.getSummaryDate() != null) ? FormUtil.simpleShortDateFormat
							.format(smsLog.getSummaryDate()) : "");
					obj1.add((smsLog.getTotalSmsIncome() != null) ? smsLog
							.getTotalSmsIncome() : "");
					obj1.add((smsLog.getTotalSmsIncomeIncorrect() != null) ? smsLog
							.getTotalSmsIncomeIncorrect() : "");
					...
					obj2.add((smsLog.getSummaryDate() != null) ? FormUtil.simpleShortDateFormat
							.format(smsLog.getSummaryDate()) : "");
					obj2.add((smsLog.getTotalSmsOutbound() != null) ? smsLog
							.getTotalSmsOutbound() : "");
				...
				Object rs = MultiReportUtil.doExportData(absolutePath,
						"TransactionReport", null, parameters, vData, columns,
