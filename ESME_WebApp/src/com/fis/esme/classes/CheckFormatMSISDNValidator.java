...
public class CheckFormatMSISDNValidator extends AbstractValidator {
	...
	// private String regexp_c8409 = "[0-9\\+]{14}$";
	// private String regexp_c8401 = "[0-9\\+]]{15}$";
	// private String regexp_c849 = "[0-9\\+]]{13}$";
	// private String regexp_c841 = "[0-9\\+]]{14}$";

	private String regexp = "[0-9\\-+]{1,20}$";

	Pattern pattern = null;
	Matcher matcher = null;

	public CheckFormatMSISDNValidator(String errorMessage) {
		super(errorMessage);
	}

	public static void main(String[] arg) {
		CheckFormatMSISDNValidator s = new CheckFormatMSISDNValidator("lỗi");
		System.out.println(s.isValid("016425-4485"));
		System.out.println(s.isValid("+8409472321989"));
		System.out.println(s.isValid("+5841642554485"));
		System.out.println(s.isValid("849423219895"));
		System.out.println(s.isValid("+0048494-23219895"));
		System.out.println(s.isValid("+840909123123"));
		System.out.println(s.isValid("+8401642554485"));
	}

	public static boolean checkMSISDN(String msisdn) {
		CheckFormatMSISDNValidator s = new CheckFormatMSISDNValidator(null);
		return s.isValid(msisdn);
	}
	...
	public boolean isValid(Object value) {
		...
		for (String val : str) {
			...
			// } else if (val.startsWith("+849")) {
			// System.out.println(">>>>>>+849" + val);
			// pattern = Pattern.compile(regexp_c849);
			// }
			// else {
			// System.out.println(">>>>>>+8409" + val);
