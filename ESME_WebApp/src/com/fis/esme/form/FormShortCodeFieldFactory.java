...
public class FormShortCodeFieldFactory extends DefaultFieldFactory implements PropertyExisted {

	private final TextField txtCode = new TextField(TM.get("Shortcode.field_code.caption"));
	private final TextField txtPrice = new TextField(TM.get("Shortcode.field_price.caption"));
	private final TextField txtMtFreeNumber = new TextField(TM.get("Shortcode.field_mtfreenumber.caption"));
	private final TextArea txtDescription = new TextArea(TM.get("Shortcode.field_description.caption"));
	private final ComboBox cbbStatus = new ComboBox(TM.get("Shortcode.field_status.caption"));
	...
	public void initComboBox() {
		...
		cbbStatus.setItemCaption(strActive, TM.get("Shortcode.field_combobox.value_active"));
		cbbStatus.setItemCaption(strInactive, TM.get("Shortcode.field_combobox.value_inactive"));
	...
	private void initTextField() {
		...
		String errorCodeMsg = TM.get("common.field.msg.validator_only*", txtCode.getCaption());
		validatechater = new CustomRegexpValidator(TM.get("Shortcode.field_code.regexp.validator_error", txtCode.getCaption()), true, errorCodeMsg, true);

		validateNumber = new CustomRegexpValidator(TM.get("Shortcode.field_code.regexp.validator_errornumber", txtCode.getCaption()), true, errorCodeMsg, true);
		...
		String errorPriorityMsg1 = TM.get("common.field.msg.validator_isint", txtPrice.getCaption());
		...
		String errorPriorityMsg2 = TM.get("common.field.msg.validator_isint", txtMtFreeNumber.getCaption());
