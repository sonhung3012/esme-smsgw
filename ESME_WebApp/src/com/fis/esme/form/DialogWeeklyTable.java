...
public class DialogWeeklyTable extends WDialog {
	...
	private BeanItemContainer<WeeklyTable> dataSelect = new BeanItemContainer<WeeklyTable>(
			WeeklyTable.class);
	private FormMessageScheduler parent;
	public String value;
	private Button btnOk, btnCancel;
	private HorizontalLayout buttonLayout = new HorizontalLayout();

	public DialogWeeklyTable(String caption, String type, FormMessageScheduler parent) {
		super(caption);
		this.type = type;
		this.parent = parent;
		this.setWidth("200px");
