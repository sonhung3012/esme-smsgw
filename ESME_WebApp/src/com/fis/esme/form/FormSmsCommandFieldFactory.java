...
public class FormSmsCommandFieldFactory extends DefaultFieldFactory implements
		PropertyExisted {
	private final TextField txtCode = new TextField(
			TM.get("SmsCommand.field_code.caption"));
	private final TextField txtName = new TextField(
			TM.get("SmsCommand.field_name.caption"));
	private final ComboBox cbbStatus = new ComboBox(
			TM.get("SmsCommand.field_status.caption"));
	...
	private void initComboBox() {
		...
		cbbStatus.setItemCaption(strActive,
				TM.get("SmsCommand.field_combobox.value_active"));
		cbbStatus.setItemCaption(strInactive,
				TM.get("SmsCommand.field_combobox.value_inactive"));
	...
	private void initTextField() {
		...
		txtCode.addValidator(new CustomRegexpValidator(TM.get(
				"SmsCommand.field_code.regexp.validator_error",
