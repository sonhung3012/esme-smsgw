...
public class FormApParamFieldFactory extends DefaultFieldFactory implements PropertyExisted, ObjectExistedByProperty {

	private final TextField txtType = new TextField(TM.get("ApParam.field_type.caption"));
	private final TextField txtName = new TextField(TM.get("ApParam.field_name.caption"));
	private final TextField txtValue = new TextField(TM.get("ApParam.field_value.caption"));
	private final TextArea txtDescription = new TextArea(TM.get("ApParam.field_description.caption"));
	...
	private void initTextField() {
		...
		String nullCodeMsg = TM.get("common.field.msg.validator_nulloremty", txtType.getCaption());
		...
		ObjectExistedByPropertyValidator objectExistedValicator = new ObjectExistedByPropertyValidator(TM.get("common.fields.msg.validator_existed11"), this, new AbstractField[] { txtType, txtName });
		txtName.addValidator(objectExistedValicator);

		txtValue.setMaxLength(999);
		txtValue.setWidth(TM.get("common.form.field.fixedwidth"));
		String nullNameMsgv = TM.get("common.field.msg.validator_nulloremty", txtValue.getCaption());
	...
	private void initTextArea() {
		...
		txtDescription.setMaxLength(999);
