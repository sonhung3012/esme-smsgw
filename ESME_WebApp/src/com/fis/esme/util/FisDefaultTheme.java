...
public class FisDefaultTheme extends Reindeer {
	...
	public static final ThemeResource ICON_PACKAGE = new ThemeResource("icons/16/package.png");
	public static final ThemeResource ICON_PROMOTION = new ThemeResource("icons/16/promotion.png");
	public static final ThemeResource ICON_CHARGEBAND = new ThemeResource("icons/16/chargeband.png");
	public static final ThemeResource ICON_SUB_DETAIL_PARENT = new ThemeResource("icons/16/month_calendar.png");
	public static final ThemeResource ICON_SUB_DETAIL = new ThemeResource("icons/16/chart.png");
	public static final ThemeResource ICON_OTHERS = new ThemeResource("icons/16/puzzle.png");
	public static final ThemeResource ICON_USERGROUP = new ThemeResource("icons/16/Group.gif");
	public static final ThemeResource ICON_USER = new ThemeResource("icons/16/user.png");
	public static final ThemeResource ICON_USERUNCHEKED = new ThemeResource("icons/16/user_uncheked.png");
	...
	public static final ThemeResource ICON_USER_UNCHECKED_LOCK = new ThemeResource("icons/16/user_unchecked_lock.png");
	public static final ThemeResource ICON_GROUP_CHECKED = new ThemeResource("icons/16/group_checked.png");
