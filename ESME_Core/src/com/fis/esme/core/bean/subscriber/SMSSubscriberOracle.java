...
public class SMSSubscriberOracle extends SMSSubscriber{
	public String strSubscriberSequence = "subscriber_seq";

	public int insertSubscriber(Connection con, String subid, String msisdn)
			throws Exception {
		PreparedStatement pstmtInsertSubscriber = null;
		try {
			String strSQLCommand = "INSERT INTO SUBSCRIBER(SUB_ID,MSISDN,STATUS,CREATE_DATE,EMAIL) VALUES(?,?,'1',SYSDATE,?)";
