...
public class SMSCListener extends SmppObject implements Runnable
{
    ...
    private void listen()
    {
        debug.enter(SMPPServer.DSIMD2, this, "SMSCListener listening on port "+port);
        try {
            ...
            if (connection != null) {
                ...
                debug.write(SMPPServer.DSIMD2, "no connection accepted this time.");
            }
        ...
        debug.exit(SMPPServer.DSIMD2, this);
    }
