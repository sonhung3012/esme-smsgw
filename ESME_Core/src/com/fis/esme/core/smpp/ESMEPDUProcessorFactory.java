...
public class ESMEPDUProcessorFactory implements PDUProcessorFactory
{
     ...
     */   
    public ESMEPDUProcessorFactory(SMPPServer server, PDUProcessorGroup procGroup,
                                        Ehcache submitCache,
                                        Ehcache deliveryCache,
                                        SequenceObject serverSequence)
    {
    	this.server = server;
    ...
    {
        ESMEPDUProcessor simPDUProcessor
            = new ESMEPDUProcessor(server, session, submitCache);
        simPDUProcessor.setDisplayInfo(getDisplayInfo());
        simPDUProcessor.setGroup(procGroup);
        simPDUProcessor.setDeliveryCache(deliveryCache);
        simPDUProcessor.setServerSequence(serverSequence);
