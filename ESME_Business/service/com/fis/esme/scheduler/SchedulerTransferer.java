...
public class SchedulerTransferer {
	...
	public List<EsmeScheduler> findAllWithOrderPaging(EsmeScheduler esmeScheduler, String sortedColumn, boolean asc, int firstItemIndex, int maxItems, boolean exactMatch) throws Exception {

		return bo.findAll(esmeScheduler, sortedColumn, asc, firstItemIndex, maxItems, exactMatch);
	}
