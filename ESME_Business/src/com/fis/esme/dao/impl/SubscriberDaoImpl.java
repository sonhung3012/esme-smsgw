...
public class SubscriberDaoImpl extends
		GenericDaoSpringHibernateTemplate<Subscriber, Long> implements
		SubscriberDao {

	@SuppressWarnings("unchecked")
	@Override
	public List<Subscriber> findAll(Subscriber esmeServices)
			throws Exception {
	 ...
	 * 
	 * */
	private Criteria createCriteria(Subscriber esmeServices,
		...
		if (orderedColumn != null
				&& FieldChecker.classContainsField(Subscriber.class,
						orderedColumn)) {
			if (asc) {
	...
	@Override
	public int count(Subscriber esmeServices, boolean exactMatch)
			throws Exception {
...
//		return l;
	...
	public int checkExited(Subscriber esmeServices) throws Exception {
		...
		String strSQL = "select count(*) total from SUBSCRIBER where "
				+ " msisdn=:msisdn ";
//		if (esmeServices != null) {
