...
public interface EsmeIsdnSpecialBo extends GenericBo<EsmeIsdnSpecial, String> {
	...
	List<EsmeIsdnSpecial> findAll(SearchEntity searchEntity,
			EsmeIsdnSpecial esmeIsdnSpecial, boolean exactMatch) throws Exception;
	...
	int checkExited(SearchEntity searchEntity, EsmeIsdnSpecial esmeIsdnSpecial) throws Exception;

	int countAll() throws Exception;

	boolean checkConstraints(String id) throws Exception;
	
	List<EsmeIsdnPermission> getPermissionByMisdn(String msisdn) throws Exception;
	
	void deletePermissionByMsisdn(String msisdn) throws Exception;
	
	void updateSpecial(EsmeIsdnSpecial esmeIsdnSpecial,String oldMsisdn) throws Exception;
}
