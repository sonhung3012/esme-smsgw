 ...
 */
public class SubscriberBoImpl extends
		GenericBoImp<Subscriber, Long, SubscriberDao> implements
		SubscriberBo {
	...
	@Override
	public List<Subscriber> findAll(Subscriber prcService)
			throws Exception {
	...
	@Override
	public int count(Subscriber prcService, boolean exactMatch)
			throws Exception {
