 ...
 * generated in the com.fis.esme.cpsummary package. 
...
public class ObjectFactory {
    ...
    private final static QName _FindAllByDateResponse_QNAME = new QName("http://cpsummary.esme.fis.com/", "findAllByDateResponse");
    private final static QName _FindAllInDateByField_QNAME = new QName("http://cpsummary.esme.fis.com/", "findAllInDateByField");
    private final static QName _FindAllByDateByListField_QNAME = new QName("http://cpsummary.esme.fis.com/", "findAllByDateByListField");
    private final static QName _FindAllByDateAndIdResponse_QNAME = new QName("http://cpsummary.esme.fis.com/", "findAllByDateAndIdResponse");
    private final static QName _FindAllByDateByListFieldResponse_QNAME = new QName("http://cpsummary.esme.fis.com/", "findAllByDateByListFieldResponse");
    private final static QName _FindAllInDateByFieldResponse_QNAME = new QName("http://cpsummary.esme.fis.com/", "findAllInDateByFieldResponse");
    private final static QName _FindAllByDateAndId_QNAME = new QName("http://cpsummary.esme.fis.com/", "findAllByDateAndId");
    private final static QName _FindAllByDate_QNAME = new QName("http://cpsummary.esme.fis.com/", "findAllByDate");
    private final static QName _Exception_QNAME = new QName("http://cpsummary.esme.fis.com/", "Exception");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.fis.esme.cpsummary
     * 
     */
    ...
    /**
     * Create an instance of {@link EsmeDailyCpSummary }
     * 
     */
    public EsmeDailyCpSummary createEsmeDailyCpSummary() {
        return new EsmeDailyCpSummary();
    }
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://cpsummary.esme.fis.com/", name = "findAllByDateResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://cpsummary.esme.fis.com/", name = "findAllInDateByField")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://cpsummary.esme.fis.com/", name = "findAllByDateByListField")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://cpsummary.esme.fis.com/", name = "findAllByDateAndIdResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://cpsummary.esme.fis.com/", name = "findAllByDateByListFieldResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://cpsummary.esme.fis.com/", name = "findAllInDateByFieldResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://cpsummary.esme.fis.com/", name = "findAllByDateAndId")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://cpsummary.esme.fis.com/", name = "findAllByDate")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://cpsummary.esme.fis.com/", name = "Exception")
