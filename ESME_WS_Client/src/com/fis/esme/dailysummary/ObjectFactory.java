 ...
 * generated in the com.fis.esme.dailysummary package. 
...
public class ObjectFactory {
    ...
    private final static QName _Exception_QNAME = new QName("http://dailysummary.esme.fis.com/", "Exception");
    private final static QName _FindAllByDate_QNAME = new QName("http://dailysummary.esme.fis.com/", "findAllByDate");
    private final static QName _FindAllByDateByListField_QNAME = new QName("http://dailysummary.esme.fis.com/", "findAllByDateByListField");
    private final static QName _FindAllInDateByFieldResponse_QNAME = new QName("http://dailysummary.esme.fis.com/", "findAllInDateByFieldResponse");
    private final static QName _FindAllByDateByListFieldResponse_QNAME = new QName("http://dailysummary.esme.fis.com/", "findAllByDateByListFieldResponse");
    private final static QName _FindAllByDateResponse_QNAME = new QName("http://dailysummary.esme.fis.com/", "findAllByDateResponse");
    private final static QName _FindAllInDateByField_QNAME = new QName("http://dailysummary.esme.fis.com/", "findAllInDateByField");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.fis.esme.dailysummary
     * 
     */
    ...
    /**
     * Create an instance of {@link EsmeDailySummary }
     * 
     */
    public EsmeDailySummary createEsmeDailySummary() {
        return new EsmeDailySummary();
    }
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://dailysummary.esme.fis.com/", name = "Exception")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://dailysummary.esme.fis.com/", name = "findAllByDate")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://dailysummary.esme.fis.com/", name = "findAllByDateByListField")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://dailysummary.esme.fis.com/", name = "findAllInDateByFieldResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://dailysummary.esme.fis.com/", name = "findAllByDateByListFieldResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://dailysummary.esme.fis.com/", name = "findAllByDateResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://dailysummary.esme.fis.com/", name = "findAllInDateByField")
