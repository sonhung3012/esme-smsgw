...
public interface SchedulerTransferer {
    ...
    public int checkExisted(
        ...
        com.fis.esme.persistence.EsmeScheduler arg0
    );
    ...
    public java.util.List<com.fis.esme.persistence.EsmeScheduler> findAllWithOrderPaging(
        @WebParam(name = "arg0", targetNamespace = "")
        com.fis.esme.persistence.EsmeScheduler arg0,
        @WebParam(name = "arg1", targetNamespace = "")
