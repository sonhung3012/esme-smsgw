...
public interface SubscriberDTTransferer {
    ...
    public void update(
        ...
        com.fis.esme.persistence.Subscriber arg0,
    ...
    public int count(
        ...
        @WebParam(name = "arg1", targetNamespace = "")
        com.fis.esme.persistence.Subscriber arg1,
    ...
    public java.util.List<com.fis.esme.persistence.Subscriber> findAllWithOrderPaging(
        @WebParam(name = "arg0", targetNamespace = "")
        com.fis.esme.persistence.SearchEntity arg0,
        @WebParam(name = "arg1", targetNamespace = "")
        com.fis.esme.persistence.Subscriber arg1,
